...
* решаются задачи в области кибербезопасности и защиты информации:
  ...
  * так как от целевого ресурса скрывается истинный источник запроса, то конечный пользователь защищается от "фишинга" и "трекинга", а также позволяет осуществлять обход блокировки, установленной целевым ресурсом в отношении пользователя;
